        ...
        <div class="w3-container">
            ...
            <div class="w3-container w3-card">
                <div class="w3-margin">
                    ...
                    <div id="course" class="w3-card w3-margin-left">
                        <h4 class="w3-panel w3-gray">Filename</h4>
                        <div>// Chapter 1</div>
                        <div>// Chapter 2</div>
                    </div>
                    <br>
                    <button class="w3-button w3-round-large w3-right w3-indigo" onclick="location.href='studentSubmission.php'">Open</button>
                </div>
                <br><br>
                ...
                <button class="w3-button w3-round-large w3-right w3-indigo" onclick="location.href='courseList.php'">Open</button>
                <br><br>
                <div class="w3-border w3-border-gray w3-topbar"></div>
