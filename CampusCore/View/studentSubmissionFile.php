...
<body>
    ...
    <div class="w3-half">
        <div class="w3-margin-top w3-margin-left w3-text-indigo">
            <a href="studentSubmission.php">< back</a>
        </div>
        <!-- Courses title -->
            ...
            <div class="w3-container w3-card">
                <div class="w3-margin">
                            ...
                            if ($conn)
                            {
                                ...
                                if (mysqli_num_rows($record)>0)
                                {
                                    ...
                                    while ($rec = mysqli_fetch_row($record))
                                    {
                                        ...
                                        echo "  <td>".$rec[3]."</td>";
                                        echo "  <td>".$rec[4]."</td>";
                                        echo "  <td class='w3-row'><a class='w3-button w3-small w3-pink w3-round-xlarge w3-half' href='delete.php?row=$rec[0]'>&#128465;</a>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="w3-padding-32 w3-card w3-margin-left w3-container">
                            <div class="w3-center">
                                <h3>Drag or Drop your file(s) here</h3>
                                <p>PDF format not more than 15 MB</p>
                                <input type="file" name="file" accept="application/pdf" size="15000000" class="w3-button w3-round-large w3-indigo"> <br>
                                <input type="submit" name="fileSubmit" value="Upload" class="w3-button w3-indigo w3-right w3-round-large">
                            </div>
                        </div>
                    </form>
                    <?php
